...
python3 -u /opt/gugik2osm/git/processing/scripts/expired_tiles.py --insert-exp-tiles --dir /opt/gugik2osm/imposm3/exptiles/ --all --dsn "host=$PGHOSTADDR port=$PGPORT dbname=$PGDATABASE user=$PGUSER password=$PGPASSWORD" >> /opt/gugik2osm/log/data_update.log 2>&1
