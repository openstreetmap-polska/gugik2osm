...
with DAG(
    ...
    remove_old_imposm_files_task = BashOperator(
        ...
        bash_command=r"""
            set -e;
            find /opt/gugik2osm/imposm3/imposm_diff/0* -mtime +7 -type f -exec rm {} \;
    ...
    remove_old_changesets_task = BashOperator(
        ...
        bash_command=r"""
            set -e;
            find /opt/gugik2osm/temp_changesets/**/*.osm.gz -mtime +1 -type f -exec rm {} \;
    ...
    remove_old_airflow_logs_task = BashOperator(
        ...
        bash_command=r"""
            set -e;
            find /opt/gugik2osm/airflow/logs/**/*.log -mtime +15 -type f -exec rm {} \;
