...
insert into process_locks values ('prg_full_update', false, null, null, null) on conflict do nothing;
insert into process_locks values ('prg_partial_update', false, null, null, null) on conflict do nothing;
insert into process_locks values ('teryt_update', false, null, null, null) on conflict do nothing;
