...
python3 -u /opt/gugik2osm/git/processing/scripts/expired_tiles.py --insert-exp-tiles --dir /opt/gugik2osm/imposm3/exptiles/ --all --dotenv /opt/gugik2osm/conf/.env >> /opt/gugik2osm/log/data_update.log 2>&1
